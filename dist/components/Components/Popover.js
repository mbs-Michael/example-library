...
var _Buttons = require("../Inputs/Buttons");
...
class Popover extends _react.default.Component {
  ...
  render() {
    ...
    }, screenSize < 768 && /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_Buttons.ButtonDefault, {
      icon: "times",
      buttonProps: {
        onClick: () => {
          this.setState({
